...
pub(crate) trait WriteIntExt: Write {
    #[inline]
    fn write_i16_by(&mut self, n: i16, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, i16, endian, n)
    }

    #[inline]
    fn write_i24_by(&mut self, n: i32, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, i24, endian, n)
    }

    #[inline]
    fn write_i32_by(&mut self, n: i32, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, i32, endian, n)
    }

    #[inline]
    fn write_i48_by(&mut self, n: i64, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, i48, endian, n)
    }

    #[inline]
    fn write_i64_by(&mut self, n: i64, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, i64, endian, n)
    }

    #[inline]
    fn write_u16_by(&mut self, n: u16, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, u16, endian, n)
    }

    #[inline]
    fn write_u24_by(&mut self, n: u32, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, u24, endian, n)
    }

    #[inline]
    fn write_u32_by(&mut self, n: u32, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, u32, endian, n)
    }

    #[inline]
    fn write_u48_by(&mut self, n: u64, endian: bool) -> Result<(), std::io::Error> {
        write_int_by!(self, u48, endian, n)
    }

    #[inline]
    fn write_u64_by(&mut self, n: u64, endian: bool) -> Result<(), std::io::Error> {
...
pub(crate) trait ReadVecExt: ReadIntExt {
    ...
    #[inline]
    fn read_i16_vec_by(&mut self, endian: bool) -> Result<Vec<i16>, std::io::Error> {
        read_array_by!(self, i16, endian)
    }

    #[inline]
    fn read_i24_vec_by(&mut self, endian: bool) -> Result<Vec<i32>, std::io::Error> {
        read_array_by!(self, i24, endian)
    }

    #[inline]
    fn read_i32_vec_by(&mut self, endian: bool) -> Result<Vec<i32>, std::io::Error> {
        read_array_by!(self, i32, endian)
    }

    #[inline]
    fn read_i48_vec_by(&mut self, endian: bool) -> Result<Vec<i64>, std::io::Error> {
        read_array_by!(self, i48, endian)
    }

    #[inline]
    fn read_i64_vec_by(&mut self, endian: bool) -> Result<Vec<i64>, std::io::Error> {
        read_array_by!(self, i64, endian)
    }

    #[inline]
    fn read_u8_vec_by(&mut self, endian: bool) -> Result<Vec<u8>, std::io::Error> {
        let iter = 0..self.read_u32_by(endian)?;
        iter.map(|_| self.read_u8()).collect()
    }

    #[inline]
    fn read_u16_vec_by(&mut self, endian: bool) -> Result<Vec<u16>, std::io::Error> {
        read_array_by!(self, u16, endian)
    }

    #[inline]
    fn read_u24_vec_by(&mut self, endian: bool) -> Result<Vec<u32>, std::io::Error> {
        read_array_by!(self, u24, endian)
    }

    #[inline]
    fn read_u32_vec_by(&mut self, endian: bool) -> Result<Vec<u32>, std::io::Error> {
        read_array_by!(self, u32, endian)
    }

    #[inline]
    fn read_u48_vec_by(&mut self, endian: bool) -> Result<Vec<u64>, std::io::Error> {
        read_array_by!(self, u48, endian)
    }

    #[inline]
    fn read_u64_vec_by(&mut self, endian: bool) -> Result<Vec<u64>, std::io::Error> {
